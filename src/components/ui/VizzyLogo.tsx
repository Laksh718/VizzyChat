 ...
 */
export default function VizzyLogo({
  size = 40,
  showTail = true,
}: VizzyLogoProps) {
  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id={`${uid}drop`} x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow
            ...
            dy="3"
            stdDeviation="5"
            floodColor="rgba(124,58,237,0.5)"
          />
          <feDropShadow
            dx="0"
            dy="1"
            stdDeviation="2"
            floodColor="rgba(236,72,153,0.35)"
          />
        </filter>
      </defs>
      ...
      <g filter={`url(#${uid}drop)`}>
        ...
        <path
          d="M50,50 L50,6 A44,44 0 0,1 91.8,36.4 Z"
          fill={`url(#${uid}g0)`}
        />
        {/* Sector 1 · blue → cyan     (342° →  54°) */}
        <path
          d="M50,50 L91.8,36.4 A44,44 0 0,1 75.9,85.6 Z"
          fill={`url(#${uid}g1)`}
        />
        {/* Sector 2 · cyan → pink     ( 54° → 126°) */}
        <path
          d="M50,50 L75.9,85.6 A44,44 0 0,1 24.1,85.6 Z"
          fill={`url(#${uid}g2)`}
        />
        {/* Sector 3 · pink → orange   (126° → 198°) */}
        <path
          d="M50,50 L24.1,85.6 A44,44 0 0,1 8.2,36.4 Z"
          fill={`url(#${uid}g3)`}
        />
        {/* Sector 4 · orange → violet (198° → 270°) */}
        <path
          d="M50,50 L8.2,36.4 A44,44 0 0,1 50,6 Z"
          fill={`url(#${uid}g4)`}
        />
